...
public class ReformatPhoneNumber1694 {
    public static void main(String[] args) {
        Solution solution = new ReformatPhoneNumber1694().new Solution();
    ...
    class Solution {
        public String reformatNumber(String number) {
            ...
            for (int i = 0; i < b1.length(); i += 3) {
                if (i == b1.length() - 4) {
                    res.append(b1.substring(i, b1.length() - 2));
                    res.append('-');
                    res.append(b1.substring(b1.length() - 2, b1.length()));
                    res.append('-');
                    break;
                }
                res.append(b1.substring(i, Math.min(i + 3, b1.length())));
                res.append('-');
            }
