package leetcode.editor.cn;//请你仅使用两个栈实现先入先出队列。队列应当支持一般队列支持的所有操作（push、pop、peek、empty）：
//
// 实现 MyQueue 类： 
//
// 
...
public class ImplementQueueUsingStacks232 {
    ...
    class MyQueue {
        ...
        public void push(int x) {
            this.stack1.addLast(x);
        }

        public int pop() {
            if (this.stack2.isEmpty()) {
                while (!this.stack1.isEmpty()) {
                    this.stack2.addLast(this.stack1.removeLast());
                }
            }
