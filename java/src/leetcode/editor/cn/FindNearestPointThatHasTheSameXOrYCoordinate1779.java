...
public class FindNearestPointThatHasTheSameXOrYCoordinate1779 {
    public static void main(String[] args) {
        Solution solution = new FindNearestPointThatHasTheSameXOrYCoordinate1779().new Solution();
    }
    ...
    class Solution {
        ...
        public int nearestValidPoint(int x, int y, int[][] points) {
            ...
            for (int i = 0; i < points.length; i++) {
                ...
                int distance = this.manhattanDistance(x, y, x1, y1);
            ...
            return minDistance == Integer.MAX_VALUE ? -1 : res;
        }
